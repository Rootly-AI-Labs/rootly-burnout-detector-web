                      ...
                      >
                        <CardContent className="p-4">
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            ...
                            {/* GitHub - code repository - only show if user has mapped GitHub username */}
                            {(member.github_activity && member.github_activity.username && member.github_activity.username !== 'unknown') && (
                            ...
                            {/* Slack - communication - only show if user has mapped Slack username */}
                            {(member.slack_activity && member.slack_activity.username && member.slack_activity.username !== 'unknown') && (
